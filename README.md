...
![Withdrawal form](docs/screenshots/filling_withdrawal_form.png)

### Balance validation rule

![Balance validation rule](docs/screenshots/balance_must_be%20less.png)

### Retirement age rule

![Retirement age rule](docs/screenshots/age_rule.png)

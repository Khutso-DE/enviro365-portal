...
function App() {
  ...
  const scrollToWithdrawals = () => document.getElementById('withdrawal-history')?.scrollIntoView({ behavior: 'smooth', block: 'start' })
  ...
  return (
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <nav><button className="nav-item active" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}><span>◈</span> Portfolio</button><button className="nav-item" onClick={scrollToWithdrawals}><span>↗</span> Withdrawals</button></nav>
